...
$body ="Here is the message from the website: 1\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: Chia.Pan@seattlecolleges.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from the website 2'; // if your client has more than one web site, you can put the site name here.
...
mail ('Chia.Pan@seattlecolleges.edu', $subject, $body, $from);
